...
import { PatientCalendarPanel } from "@/components/scheduling/PatientCalendarPanel";
      ...
      <div className="container">
        ...
        <div className="mb-3">
          <Link href="/psychologists">
            <Button fullWidth>Ver todos os psicólogos</Button>
          </Link>
        </div>

        <div className="mb-3">
          <PatientCalendarPanel />
        </div>

        <h2 className="section-heading">Histórico de consultas</h2>
